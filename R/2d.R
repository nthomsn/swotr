...
circos.par(cell.padding=c(0,0,0,0), gap.degree=0, start.degree=270, clock.wise=TRUE)
...
circos.par("canvas.xlim" = c(-1.25, 1.25), "canvas.ylim" = c(-1.25, 1.25), 
           gap.degree = 0, start.degree = 270, clock.wise = TRUE)
