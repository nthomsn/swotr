...
dat <- read.csv("Gout_connection_data.csv", sep = ",", head = FALSE);
# import heat connection data from csv
heat <- read.csv("Gout_heat_map_data.csv", sep = ",");
...
factors = rep(letters[1:6], times=c(10,3,6,7,2,10))
