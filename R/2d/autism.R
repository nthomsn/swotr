...
dat <- read.csv("Autism_connection_data.csv", sep = ",", head = FALSE);
# import heat connection data from csv
heat <- read.csv("Autism_heat_map_data.csv", sep = ",");
...
factors = rep(letters[1:6], times=c(15,8,19,27,19,39))
